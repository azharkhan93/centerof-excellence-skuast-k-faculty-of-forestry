...
export const TopBar: React.FC = () => {
    return (
        <div className="w-full bg-slate-950/40 backdrop-blur-md border-b border-white/5 py-2 px-6 md:px-16 flex justify-end items-center text-[10px] md:text-xs font-medium tracking-widest  text-white/60">
